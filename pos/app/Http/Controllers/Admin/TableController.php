...
class TableController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        // dd($this->table->count());
     if($this->table->count()<51 && $request->number<51 && $request->capacity<21){
        $table = $this->table;
        ...
        Toastr::success(translate('Table number will be less than 50 & capacity number will be less than 20'));
