                ...
                <div class="card">
                    ...
                    <div class="pos-title">
                        <div class="d-flex flex-row bd-highlight mb-3">
                            ...
                            <div class="p-2 bd-highlight">
                                <h4 class="mb-0">{{ translate('user') }}: {{ auth('branch')->user()->id }}</h4>
                            </div>
                                ...
                                <div class="input-group input-group-merge input-group-flush border rounded">
                                    <div class="input-group-prepend pl-2">
                                        <div class="input-group-text">
                                            ...
                                            <img width="13" src="{{ asset('assets/admin/img/icons/search.png') }}"
                                                alt="">
                                        </div>
                                    </div>
                    ...
                    <div class="p-2 p-sm-4">
                        ...
                        <div class="d-none" id="dine_in_section">
                            <div class="form-group d-flex flex-wrap flex-sm-nowrap gap-2">
                                <select onchange="store_key('table_id',this.value)" id='table' name="table_id"
                                    class="table-data-selector form-control form-ellipsis">
                                    <option selected disabled>{{ translate('Select Table') }}</option>
                                    @foreach ($tables as $table)
                                        <option value="{{ $table['id'] }}"
                                            {{ $table['id'] == session('table_id') ? 'selected' : '' }}>
