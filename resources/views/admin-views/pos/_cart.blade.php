...
<!-- {{dump(session()->get('cart'))}} -->
    ...
    <div class="pos-data-table p-3">
        <dl class="row">
            ...
            <dd class="col-6 text-right">
                {{-- {{ dump($total_tax) }} --}}
                {{ \App\CentralLogics\Helpers::set_symbol(round($total_GST + $addon_total_tax, 2)) }}</dd>
            ...
            <dd class="col-6 text-right border-top font-weight-bold pt-2">
                {{ \App\CentralLogics\Helpers::set_symbol(round($total + $total_tax + $addon_total_tax + $delivery_charge+$total_GST, 2)) }}
            </dd>
        </dl>
                    ...
                    <form action="{{ route('admin.pos.discount') }}" method="post" class="row mb-0">
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <input type="number" class="form-control" name="discount"
                                value="{{ session()->get('cart')['extra_discount'] ?? 0 }}" min="0"
                                step="0.1">
                        </div>
                        <div class="form-group col-sm-6">
