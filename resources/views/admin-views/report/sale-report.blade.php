        ...
        <div class="card-body">
            <div class="media flex-column flex-sm-row flex-wrap align-items-sm-center gap-4">
                ...
                <div class="avatar avatar-xl">
                    <img class="avatar-img" src="{{asset('assets/admin')}}/svg/illustrations/credit-card.svg" alt="Image Description">
                </div>
                <!-- End Avatar -->
            ...
            <form action="javascript:" id="search-form" method="POST">
                ...
                <div class="row g-2">
                    ...
                    <div class="col-md-4 d-flex flex-column gap-2">
                        <div>
                            <strong>
                                {{translate('total_Orders')}} : <span id="order_count"> </span>
                            </strong>
                        </div>
                        <div>
                            <strong>
                                {{translate('total_Item_Qty')}}: <span id="item_count"> </span>
                            </strong>
                        </div>
                        <div>
                            <strong>
                    ...
                    <div class="col-md-6 d-flex flex-column gap-2">
                        <div>
                            <strong>
                                {{translate('total')}} {{translate('Void')}} : <span id="order_void_amount"></span>
                            </strong>
                        </div>
                        <div>
                            <strong>
                                {{translate('total')}} {{translate('Refund')}} : <span id="order_refund_amount"></span>
                            </strong>
                        </div>

                        <div>
                            <strong>
                                {{translate('total')}} {{translate('Refund')}} {{translate('amount')}} : <span id="order_refund_amount"></span>
                            </strong>
                        </div>
                    </div>
