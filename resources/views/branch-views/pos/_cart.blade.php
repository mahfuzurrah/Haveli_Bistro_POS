...
<div class="pos-data-table p-3">
    <dl class="row">
        ...
        <dd class="col-6 text-right">{{ \App\CentralLogics\Helpers::set_symbol(round($total_GST + $addon_total_tax,2)) }}</dd>
        ...
        <dd class="col-6 text-right border-top font-weight-bold pt-2">{{ \App\CentralLogics\Helpers::set_symbol(round($grand_total+$total_tax+$addon_total_tax, 2)) }}</dd>
    </dl>
